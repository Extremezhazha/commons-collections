...
public class SortedMapBag<E> extends AbstractMapBag<E> implements SortedBag<E>, Serializable {

    /** Serial version lock */
    private static final long serialVersionUID = -7740146511091606677L;

    /**
     * Constructs an empty {@link TreeBag}.
     *
     * @param emptySortedMap empty sorted map container
     */
    public SortedMapBag(SortedMap<E, MutableInteger> emptySortedMap) {
        super(emptySortedMap);
    }
     ...
     */
    public SortedMapBag(SortedMap<E, MutableInteger> emptySortedMap, final Collection<? extends E> coll) {
        this(emptySortedMap);
        addAll(coll);
    }
     ...
     *
     * @param mapFactory  the transformer that makes a map from a comparator
     * @param in  the input stream
     * @throws IOException if an error occurs while reading from the stream
     * @throws ClassNotFoundException if an object read from the stream can not be loaded
     */
    private void readObject(Transformer<Comparator<? super E>, Map<E, MutableInteger>> mapFactory, final ObjectInputStream in) throws IOException, ClassNotFoundException {
        in.defaultReadObject();
        @SuppressWarnings("unchecked")  // This will fail at runtime if the stream is incorrect
        final Comparator<? super E> comp = (Comparator<? super E>) in.readObject();
        super.doReadObject(mapFactory.transform(comp), in);
    }
